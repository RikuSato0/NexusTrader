...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Decimal("0.005"), 10, 1, True, [Decimal("0.002"), Decimal("0.002"), Decimal("0.001")], 10/3),
        (Decimal("0.005"), 10, 5, False, [Decimal("0.003"), Decimal("0.002")], 10/2),
        (Decimal("0.005"), 10, 5, True, [Decimal("0.003"), Decimal("0.002")], 10/2),
        (Decimal("0.009"), 10, 1, False, [Decimal("0.002")] * 3 + [Decimal("0.003")], 10/4),
        (Decimal("0.009"), 10, 1, True, [Decimal("0.002")] * 4 + [Decimal("0.001")], 10/5),
    ],
)
def test_cal_twap_orders(ems: BinanceExecutionManagementSystem, total_amount: Decimal, duration: float, wait: float, reduce_only: bool, expected_amounts: List[Decimal], expected_wait: float):
